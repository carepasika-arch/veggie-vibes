const reviews = [
  {
    quote:
      "Finally a juice that doesn't taste like sugar water. The Green Clean is my morning ritual.",
    name: "Care",
  ...
  {
    quote:
      "I order through GrabFood twice a week. Deep De is unreal — like a bottled sunset.",
    name: "Pukkie",
  ...
  {
    quote:
      "You can actually taste the freshness. My skin has never looked better, honestly.",
    name: "Nacny",
          ...
          {reviews.map((r, i) => (
            ...
            >
              ...
              <figcaption className="mt-6 flex items-center gap-3">
                ...
                <div className="ml-auto text-xs" style={{ color: r.color }}>
                  ★★★★★
                </div>
              </figcaption>
            </figure>
