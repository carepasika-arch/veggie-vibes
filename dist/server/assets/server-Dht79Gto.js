...
}, Nt = ee$3.toString(), bt = An$1.toString(), vt = En$1.toString(), Pr$1 = () => {
...
async function Dr(e, r, t) {
  ...
  return C in t && (a.push(I(e.base, C)), s.push(Ue(rr(e.base), await N(e, r, $e(t))))), v in t && (a.push(I(e.base, v)), s.push(je(tr(e.base), await N(e, r, Qe(t))))), P$2 in t && (a.push(I(e.base, P$2)), s.push($(t[P$2]))), R in t && (a.push(I(e.base, R)), s.push(t[R] ? H : J)), { k: a, v: s };
}
...
var Fr = class {
  ...
  deserialize(r) {
    return p$2(this._p, this.depth, r);
  }
};
function jt(e, r) {
...
function Jn(e, r, t) {
  ...
  for (let i = 0, u; i < a; i++) u = n2[i], u && (s[i] = p$2(e, r, u));
  return Vt(s, t.o), s;
}
function Zn(e) {
  switch (e) {
...
function Xn(e, r, t, n2, a) {
  if (typeof n2 == "string") Bt(t, D(n2), p$2(e, r, a));
  else {
    let s = p$2(e, r, n2);
    switch (typeof s) {
      case "string":
...
function to(e, r, t) {
  ...
  for (let a = 0, s = t.a, i = s.length; a < i; a++) n2.add(p$2(e, r, s[a]));
  return n2;
}
function no(e, r, t) {
  let n2 = b(e, t.i, /* @__PURE__ */ new Map());
  for (let a = 0, s = t.e.k, i = t.e.v, u = s.length; a < u; a++) n2.set(p$2(e, r, s[a]), p$2(e, r, i[a]));
  return n2;
}
function oo(e, r) {
  if (r.s.length > jn) throw new O(r);
  return b(e, r.i, Or$1(D(r.s)));
}
function ao(e, r, t) {
  var u;
  let n2 = Ft(t.c), a = p$2(e, r, t.f), s = (u = t.b) != null ? u : 0;
  if (s < 0 || s > a.byteLength) throw new O(t);
  return b(e, t.i, new n2(a, s, t.l));
}
function so(e, r, t) {
  var i;
  let n2 = p$2(e, r, t.f), a = (i = t.b) != null ? i : 0;
...
function lo(e, r, t) {
  let n2 = ee$3(), a = b(e, t.i, n2.p), s = p$2(e, r, t.f);
  return t.s ? n2.s(s) : n2.f(s), a;
}
function co(e, r, t) {
  return b(e, t.i, Object(p$2(e, r, t.f)));
}
function fo(e, r, t) {
...
function So(e, r) {
  let t = b(e, r.i, b(e, r.s, ee$3()).p);
  return Yt(e, r.s, 22), t;
}
function mo(e, r, t) {
  let n2 = e.base.refs.get(t.i);
  if (n2) return de(e, t, t.i, 22), n2.s(p$2(e, r, t.a[1])), o;
  throw new V("Promise");
}
function po(e, r, t) {
  let n2 = e.base.refs.get(t.i);
  if (n2) return de(e, t, t.i, 22), n2.f(p$2(e, r, t.a[1])), o;
  throw new V("Promise");
}
function go(e, r, t) {
  p$2(e, r, t.a[0]);
  let n2 = p$2(e, r, t.a[1]);
  return Rt(n2);
}
function yo(e, r, t) {
  p$2(e, r, t.a[0]);
...
function No(e, r, t) {
  ...
  if (s) for (let i = 0; i < s; i++) p$2(e, r, a[i]);
  return n2;
}
function bo(e, r, t) {
  let n2 = e.base.refs.get(t.i);
  if (n2) return de(e, t, t.i, 31), n2.next(p$2(e, r, t.f)), o;
  throw new V("Stream");
}
function vo(e, r, t) {
  let n2 = e.base.refs.get(t.i);
  if (n2) return de(e, t, t.i, 31), n2.throw(p$2(e, r, t.f)), o;
  throw new V("Stream");
}
function Co(e, r, t) {
  let n2 = e.base.refs.get(t.i);
  if (n2) return de(e, t, t.i, 31), n2.return(p$2(e, r, t.f)), o;
  throw new V("Stream");
}
function Ao(e, r, t) {
  return p$2(e, r, t.f), o;
}
function Eo(e, r, t) {
  return p$2(e, r, t.a[1]), o;
}
function Io(e, r, t) {
  let n2 = b(e, t.i, wr([], t.s, t.l));
  for (let a = 0, s = t.a.length; a < s; a++) n2.v[a] = p$2(e, r, t.a[a]);
  return n2;
}
function p$2(e, r, t) {
...
function Yr(e, r, t) {
  r !== 0 && (w$2(e.base, t), e.base.flags.push({ type: r, value: m(e, t) }));
}
function Vo(e) {
  let r = "";
...
function Qt(e, r, t, n2) {
  return t ? F(e.base, t) ? (w$2(e.base, r), Ne(e, r, n2, m(e, t.i)), "") : f(e, t) : "";
}
function jo(e, r) {
...
function en(e, r, t, n2) {
  if (typeof t == "string") {
    ...
    if (F(e.base, n2)) {
      let i = m(e, n2.i);
      return w$2(e.base, r.i), s && a !== a ? jr(e, r.i, t, i) : Ne(e, r.i, s ? t : '"' + t + '"', i), "";
    }
    return (s ? t : '"' + t + '"') + ":" + f(e, n2);
  }
  return "[" + f(e, t) + "]:" + f(e, n2);
...
function rn(e, r, t) {
  let n2 = e.base;
  return F(n2, t) ? (w$2(n2, r), Mo(e, r, m(e, t.i)), "") : f(e, t);
}
function $o(e, r) {
...
function tn(e, r, t, n2, a) {
  ...
  if (F(s, n2)) {
    let i = m(e, n2.i);
    if (w$2(s, r), t.t !== 4 && t.i != null && Ur(s, t.i)) {
      let l = "(" + f(e, t) + ",[" + a + "," + a + "])";
...
function Xo(e, r) {
  ...
  return i.t === 26 && (w$2(l, i.i), t = "(" + f(e, i) + "," + t + ")"), t;
}
function Qo(e, r) {
  return q(e, r.f) + '("' + r.s + '")';
}
...
function ca(e, r) {
  let t = "", n2 = false;
  return r.f.t !== 4 && (w$2(e.base, r.f.i), t = "(" + f(e, r.f) + ",", n2 = true), t += ae(e, r.i, "(" + At + ")(" + m(e, r.f.i) + ")"), n2 && (t += ")"), t;
}
function fa(e, r) {
...
function Sa(e, r) {
  ...
  t.t !== 4 && (w$2(a, t.i), s += "(" + f(e, t)), n2.t !== 4 && (w$2(a, n2.i), s += (s ? "," : "(") + f(e, n2)), s && (s += ",");
...
function nn(e, r, t, n2) {
  let a = e.base;
  return F(a, n2) ? (w$2(a, r), Lo(e, r, t, m(e, n2.i)), "") : f(e, n2);
}
function Na(e, r) {
...
function Zr(e, r, t) {
  ...
  return C in t && (a.push(I(e.base, C)), s.push(Ue(rr(e.base), E(e, r, $e(t))))), v in t && (a.push(I(e.base, v)), s.push(je(tr(e.base), E(e, r, e.type === 1 ? re$1() : Qe(t))))), P$2 in t && (a.push(I(e.base, P$2)), s.push($(t[P$2]))), R in t && (a.push(I(e.base, R)), s.push(t[R] ? H : J)), { k: a, v: s };
}
...
var RawStream$1 = class RawStream {
...
const hasNodeBuffer$1 = !!BufferCtor$1 && typeof BufferCtor$1.from === "function";
function uint8ArrayToBase64$1(bytes) {
  if (bytes.length === 0) return "";
  if (hasNodeBuffer$1) return BufferCtor$1.from(bytes).toString("base64");
...
function base64ToUint8Array$1(base64) {
  ...
  if (hasNodeBuffer$1) {
    const buf = BufferCtor$1.from(base64, "base64");
...
const RAW_STREAM_FACTORY_BINARY$1 = /* @__PURE__ */ Object.create(null);
const RAW_STREAM_FACTORY_TEXT$1 = /* @__PURE__ */ Object.create(null);
const RAW_STREAM_FACTORY_CONSTRUCTOR_BINARY$1 = (stream) => new ReadableStream({ start(controller) {
  stream.on({
    next(base64) {
      try {
        controller.enqueue(base64ToUint8Array$1(base64));
      } catch {
      }
    },
    throw(error) {
...
const textEncoderForFactory$1 = new TextEncoder();
const RAW_STREAM_FACTORY_CONSTRUCTOR_TEXT$1 = (stream) => {
  return new ReadableStream({ start(controller) {
    stream.on({
      next(value) {
        try {
          if (typeof value === "string") controller.enqueue(textEncoderForFactory$1.encode(value));
          else controller.enqueue(base64ToUint8Array$1(value.$b64));
        } catch {
        }
      },
      throw(error) {
...
const FACTORY_BINARY$1 = `(s=>new ReadableStream({start(c){s.on({next(b){try{const d=atob(b),a=new Uint8Array(d.length);for(let i=0;i<d.length;i++)a[i]=d.charCodeAt(i);c.enqueue(a)}catch(_){}},throw(e){c.error(e)},return(){try{c.close()}catch(_){}}})}}))`;
const FACTORY_TEXT$1 = `(s=>{const e=new TextEncoder();return new ReadableStream({start(c){s.on({next(v){try{if(typeof v==='string'){c.enqueue(e.encode(v))}else{const d=atob(v.$b64),a=new Uint8Array(d.length);for(let i=0;i<d.length;i++)a[i]=d.charCodeAt(i);c.enqueue(a)}}catch(_){}},throw(x){c.error(x)},return(){try{c.close()}catch(_){}}})}})})`;
function toBinaryStream$1(readable) {
  const stream = re$1();
  ...
  (async () => {
    try {
      while (true) {
        ...
        stream.next(uint8ArrayToBase64$1(value));
      }
    } catch (error) {
      stream.throw(error);
    } finally {
...
function toTextStream$1(readable) {
  const stream = re$1();
  const reader = readable.getReader();
    ...
    try {
      while (true) {
        ...
        try {
          ...
          stream.next({ $b64: uint8ArrayToBase64$1(value) });
        }
      }
    } catch (error) {
      stream.throw(error);
...
const RawStreamSSRPlugin$1 = /* @__PURE__ */ ai$1({
  tag: "tss/RawStream",
  extends: [/* @__PURE__ */ ai$1({
    tag: "tss/RawStreamFactory",
    test(value) {
      return value === RAW_STREAM_FACTORY_BINARY$1;
    },
    parse: {
    ...
    serialize(_node, _ctx, _data) {
      return FACTORY_BINARY$1;
    },
    deserialize(_node, _ctx, _data) {
      return RAW_STREAM_FACTORY_BINARY$1;
    }
  }), /* @__PURE__ */ ai$1({
    tag: "tss/RawStreamFactoryText",
    test(value) {
      return value === RAW_STREAM_FACTORY_TEXT$1;
    },
    parse: {
      sync(_value, _ctx, _data) {
        return {};
    ...
    serialize(_node, _ctx, _data) {
      return FACTORY_TEXT$1;
    },
    deserialize(_node, _ctx, _data) {
      return RAW_STREAM_FACTORY_TEXT$1;
    }
  })],
  test(value) {
    return value instanceof RawStream$1;
  },
  parse: {
    sync(value, ctx, _data) {
      const factory = value.hint === "text" ? RAW_STREAM_FACTORY_TEXT$1 : RAW_STREAM_FACTORY_BINARY$1;
      return {
    ...
    async async(value, ctx, _data) {
      const factory = value.hint === "text" ? RAW_STREAM_FACTORY_TEXT$1 : RAW_STREAM_FACTORY_BINARY$1;
      const encodedStream = value.hint === "text" ? toTextStream$1(value.stream) : toBinaryStream$1(value.stream);
      return {
  ...
  deserialize(node, ctx, _data) {
    ...
    return ctx.deserialize(node.hint) === "text" ? RAW_STREAM_FACTORY_CONSTRUCTOR_TEXT$1(stream) : RAW_STREAM_FACTORY_CONSTRUCTOR_BINARY$1(stream);
  }
});
// @__NO_SIDE_EFFECTS__
...
const ShallowErrorPlugin$1 = /* @__PURE__ */ ai$1({
  tag: "$TSR/Error",
  test(value) {
...
var n$1 = {}, P$1 = (e) => new ReadableStream({ start: (r) => {
  e.on({ next: (a) => {
    try {
      r.enqueue(a);
    } catch (t) {
...
} }), x$1 = ai$1({ tag: "seroval-plugins/web/ReadableStreamFactory", test(e) {
  return e === n$1;
}, parse: { sync() {
  return n$1;
}, async async() {
...
var ee$2 = ai$1({ tag: "seroval/plugins/web/ReadableStream", extends: [x$1], test(e) {
  return typeof ReadableStream == "undefined" ? false : e instanceof ReadableStream;
}, parse: { sync(e, r) {
  return { factory: r.parse(n$1), stream: r.parse(re$1()) };
}, async async(e, r) {
  return { factory: await r.parse(n$1), stream: await r.parse(w$1(e)) };
}, stream(e, r) {
  return { factory: r.parse(n$1), stream: r.parse(w$1(e)) };
} }, serialize(e, r) {
...
const defaultSerovalPlugins$1 = [
  ShallowErrorPlugin$1,
  RawStreamSSRPlugin$1,
  p$1
];
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DYcexUyC.js");
...
const RawStreamSSRPlugin = /* @__PURE__ */ ai({
  ...
  test(value) {
    return value instanceof RawStream2;
  },
  parse: {
    sync(value, ctx, _data) {
...
function attachRouterServerSsrUtils({ router, manifest: manifest2, getRequestAssets, includeUnmatchedRouteAssets = true }) {
  ...
  router.serverSsr = {
    ...
    dehydrate: async (opts) => {
      ...
      const plugins = serializationAdapters ? serializationAdapters.map((t) => /* @__PURE__ */ makeSsrSerovalPlugin(t, trackPlugins)).concat(defaultSerovalPlugins$1) : defaultSerovalPlugins$1;
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Cbumjl0T.js"),
    import("./start-noOXsSm5.js"),
